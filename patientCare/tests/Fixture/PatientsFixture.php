...
class PatientsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'street_address' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-10-02 15:20:26',
                'modified' => '2018-10-02 15:20:26'
            ],
        ];
        parent::init();
    }
